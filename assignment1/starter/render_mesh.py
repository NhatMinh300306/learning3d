...
def render_cow_turntable(
    ...
    #imageio.mimsave("images/cow_render_turntable.gif", frames, duration=1000 // 15, loop=0, )
...
if __name__ == "__main__":
    ...
    #parser.add_argument("--output_path", type=str, default="images/cow_render_turn.gif")
    parser.add_argument("--image_size", type=int, default=256)
    args = parser.parse_args()
    image = render_cow(cow_path=args.cow_path, image_size=args.image_size)
    #image = render_cow_turntable(cow_path=args.cow_path, image_size=args.image_size)
